/*
 * 교수님 답안.
 * ArrayList 클래스 사용. WordInfo[]배열 대신에 ArrayList<WordList>객체 사용 하여 단어 목록 저장
 * Collections.sort메소드 사용하여 ArrayLsit 객체 정렬
 */
package assignment;
...
class WordInfoComparator1b implements Comparator<WordInfo> {
    @Override
...
public class Example1b {
    ...
    public static void main(String[] args) throws Exception {
        ...
        Collections.sort(a, new WordInfoComparator1b()); // WordInfo 목록을 count 내림차순으로 정렬한다.
